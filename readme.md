...
--------------------------------------------------------------------------------
[create credit account]
account number(8 numbers) [x:main menu] >> 10000009
name [x:main menu b:previous step] >> TEST
start deposit money [x:main menu b:previous step] >> 50000000
Err - wrong input
start deposit money [x:main menu b:previous step] >> 9000000
interest rate [x:main menu b:previous step] >> aws
Err - wrong input
interest rate [x:main menu b:previous step] >> 15
Err - wrong input
credit grade(A, B, C) [x:main menu b:previous step] >> 5
Err - wrong input
credit grade(A, B, C) [x:main menu b:previous step] >> B
--------------------------------------------------------------------------------
[input information]
   Account      Name   Current Money   Grade  Rate  Original Money   Rate Money
2030-10000009   TEST        9,000,000    B     15.0              0              0
TEST    Do you want to save this? [y:save x:main menu b:previous step] >> y
...
[whole information]
   Account      Name   Current Money   Grade  Rate  Original Money   Rate Money
2030-10000001   KIMJH       7,500,000    A     20.0              0              0
2030-10000002   POPO        2,000,000    B     15.0              0              0
2030-10000003    CSM        4,150,000    B      2.5              0              0
...
deposit account number [x:main menu] >> 2030-10000006
withdraw account number [x:main menu b:previous step] >> 20000
  Err - wrong input
withdraw account number [x:main menu b:previous step] >> 2030-10000003
remittance how much [x:main menu b:previous step] >> 20000
--------------------------------------------------------------------------------
[input information]
                  Account        Name        Money
Send Account   2030-10000003  CSM        -       20,000
Get Account    2030-10000006  KIMJH      +       20,000
Do you want to remit? [y:yes x:main menu b:previous step] >> y
  Msg - 20,000 completed to remit.
                  Account        Name        Money
Send Account   2030-10000003  CSM             4,130,000
Get Account    2030-10000006  KIMJH           5,020,000
--------------------------------------------------------------------------------
...
do you want to withdraw? [y:yes x:main menu b:previous step] >> y
  Msg - 40,000 completed to withdraw.
                  Account      Name       Money
Account        2030-10000001  KIMJH        7,460,000
--------------------------------------------------------------------------------
